...
with tab1:
    ...
    with col2:
        ...
        depreciation_revenue_ratio = st.number_input(
            ...
            min_value=0.0, 
            max_value=20.0, 
            value=3.0, #industry_data.get("depreciation_rev", 6.0), 
            step=0.1
        ) / 100
        ...
        working_capital_change_ratio = st.number_input(
            ...
            min_value=-10.0, 
            max_value=15.0, 
            value=2.0, #industry_data.get("wc_change_rev", 3.0), 
            step=0.1
        ) / 100
...
with tab5: 
    ...
    adjusted_liabilities = balance.loc['Total Liabilities Net Minority Interest'].iloc[0]  # se pueden agregar ajustes extra si hay pasivos contingentes
